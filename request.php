...
<body>
  ...
  <div class="container-fluid" id="containerhome" style=" height:auto; width:45%; margin-top: 120px;  color: white;  background: rgba(128, 128, 128, 0.8);">
  <a href="dashboard.php" style="color: white;">
      <iconify-icon icon="entypo:arrow-left" style="color: crimson; float: left;" width="60" height="60"></iconify-icon>
    </a>

   

    <h2 style="padding-top:20px; text-align:center; padding-right:15%;"><iconify-icon inline icon="ant-design:contacts-outlined"></iconify-icon>Request</h2>
    
    <br />

    <div style="line-height: 0.8;">
      <form action="" method="get" style="padding-right:20%;">
        <input type="checkbox" name="organizationpaper" value="organizationpaper" style="margin-left:40%; padding-right:20%;" >
        <label for="organizationpaper"> Organization Paper</label><br>
        <input type="checkbox" name="accreditation" value="accreditation" style="margin-left:40%;" >
        <label for="accreditation"> Accreditation</label><br>
        <input type="checkbox" name="idprocessing" value="idprocessing" style="margin-left:40%;" >
        <label for="idprocessing"> ID Processing</label><br>
        <input type="checkbox" name="certificate" value="certificate" style="margin-left:40%;">
        <label for="certificate"> Certificate of Good Moral Character</label><br><br>
      </form>
      <button type="button" class="btn btn-danger" style="margin-top: 35px; margin-left:40%; width:150px;"><a href="requirements.php" style="color: white;">Submit</button>
      <br /><br />
    </div>
  </div>
