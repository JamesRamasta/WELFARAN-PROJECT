...
<body>
  ...
  <div class="container-fluid" id="containerhome" style=" width: 50%; margin-left: 20px; margin-top: 150px; color: white; background:rgba(128, 128, 128, 0.8); ">
    <h2 style=" padding-top: 20px;  padding-left: 10px; "><iconify-icon inline icon="mdi:frequently-asked-questions"></iconify-icon>Frequently Asked Questions</h2>
    <br />
