...
<body>
  ...
  <div class="container" style="background: rgba(153, 0, 0, 0.8); height:400px; width:400px; color:white; margin-right:5%; margin-top:10%;">
    ...
    <input type="number" id="studentnumber" name="studentnumber" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" style="width:80%; margin-left:10%;"><br /><br />
    <label for="password" style="padding-left:10%;">Password :</label> <br />
    <input type="password" id="password" name="password" style="width:80%; margin-left:10%;"><br /><br />
    <input type="checkbox" onclick="myFunction()" style="margin-left:10%;" >Show Password <br/><br/>
    <button type="button" class="btn btn-secondary " style="margin-left:155px;"><a href="dashboard.php" style="color:white;">Login</a></button>
  ...
  <footer class="container-fluid" id="socials_section" style=" position: absolute;">
    <div class="row">
      ...
      <p style="padding-left:35%;">Photo: facebook/UST-College of Information and Computing Sciences</p>
    </div>
  </footer>
