...
<hr style="color: white;  width:40%; border-top: 2px solid white; float: left;">
  ...
  <div class="container-fluid" style="height:auto; width:50%; background-color: white; float: right;">
    <br />
    <h2 style="margin-left: 3%;">Address</h2>
    <p style="margin-left: 3%;">Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
    </p>

    <h2 style="margin-left: 3%;">Telephone</h2>
    <p style="margin-left: 3%;">Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
    </p>

    <h2 style="margin-left: 3%;">Email</h2>
    <p style="margin-left: 3%;">Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
    </p>
    <br />
  ...
  <div class="container-fluid" style="height:auto; width:50%; margin-right: 50%;  background: rgba(128, 128, 128, 0.8); ">
    <br />
    <h4 style="color:white; margin-left: 3%;"><b>Related Links:</b></h4>
 
    <p style="margin-left: 3%; color:white; ">Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
      Sample Text Sample Text Sample Text Sample Text Sample <br />
