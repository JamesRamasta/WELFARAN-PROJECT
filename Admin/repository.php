...
<body>
    ...
    <h4 style="text-align:left; padding-left:140px;"> Repository
        <a href="" style="float:right; padding-right:170px; color:black;"> Create New Repository </a>
    </h4>
    <div class="container-fluid" style="background-color: white; height: 100%; width: 80%; margin-left: 140px; font-size:25px;"><br />
        <p>Case Hearings </p>
        <hr>
        <p>Memos from OSA</p>
        <hr>
